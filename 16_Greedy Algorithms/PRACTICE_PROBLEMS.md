...
**Examples:** LeetCode [#435](https://leetcode.com/problems/non-overlapping-intervals/), [#452](https://leetcode.com/problems/minimum-number-of-arrows-to-burst-balloons/)

### Pattern 2: Farthest reach

**When to use:** You can extend coverage across an array or line.
**Examples:** LeetCode [#55](https://leetcode.com/problems/jump-game/), [#45](https://leetcode.com/problems/jump-game-ii/)

### Pattern 3: Pair extremes

**When to use:** Sorting plus smallest/largest pairing can prove an exchange argument.
**Examples:** LeetCode [#455](https://leetcode.com/problems/assign-cookies/), [#881](https://leetcode.com/problems/boats-to-save-people/)
...
**Examples:** LeetCode [#871](https://leetcode.com/problems/minimum-number-of-refueling-stops/), [#630](https://leetcode.com/problems/course-schedule-iii/)
